...
export const Menues = [
    {
        ...
        menus_list:[
            ...
            {   id:6,
                ...
                subMenu_list:[
                    { menue_list_id:28, menue_list_title: '사이트 설정', menue_list_path: `${paths.dashboard.settings}/site`},
                    { menue_list_id:29, menue_list_title: '디자인 설정', menue_list_path: `${paths.dashboard.settings}/manage/designcfg`},
                    { menue_list_id:30, menue_list_title: '도메인 설정', menue_list_path: `${paths.dashboard.settings}/manage/domain`},
                    { menue_list_id:31, menue_list_title: '전역 설정', menue_list_path: `${paths.dashboard.settings}/manage/config`},
                    { menue_list_id:32, menue_list_title: 'IP 설정', menue_list_path: `${paths.dashboard.settings}/manage/ip`},
                    { menue_list_id:33, menue_list_title: '알람음 설정', menue_list_path: `${paths.dashboard.settings}/manage/alarm`},
                    { menue_list_id:35, menue_list_title: '팝업 설정', menue_list_path: `${paths.dashboard.settings}/manage/popup`},
                    { menue_list_id:36, menue_list_title: '화면공지 설정', menue_list_path: `${paths.dashboard.settings}/manage/inline_notice`},
                    { menue_list_id:37, menue_list_title: '은행 설정', menue_list_path: `${paths.dashboard.settings}/manage/bank`},
                    { menue_list_id:38, menue_list_title: '계좌 설정', menue_list_path: `${paths.dashboard.settings}/manage/bank_guide`},
                    { menue_list_id:39, menue_list_title: '레벨별 설정', menue_list_path: `${paths.dashboard.settings}/manage/charge`},
                    { menue_list_id:40, menue_list_title: '출석체크 / 룰렛 설정', menue_list_path: `${paths.dashboard.settings}/manage/attendance`},
                    { menue_list_id:41, menue_list_title: '회원가입 설정', menue_list_path: `${paths.dashboard.settings}/manage/join`},
                    { menue_list_id:42, menue_list_title: '파트너단계 관리', menue_list_path: `${paths.dashboard.settings}/manage/partner_depth`},
                    { menue_list_id:43, menue_list_title: '알상태 관리', menue_list_path: `${paths.dashboard.settings}/manage/api_family`},
                    { menue_list_id:45, menue_list_title: '가상계좌 API 관리', menue_list_path: `${paths.dashboard.settings}/manage/coin_api`},
                    { menue_list_id:46, menue_list_title: 'FAKE 입금/출금', menue_list_path: `${paths.dashboard.settings}/manage/fake`},
                ]
            },
