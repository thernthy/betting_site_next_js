        ...
        <Table sx={{ minWidth: '100%' }}>
          <TableHead>
            <TableRow>
              ...
              <TableCell className='whitespace-nowrap' sx={{textAlign:'center'}}>이전포인트</TableCell>
              <TableCell className='whitespace-nowrap' sx={{textAlign:'center'}}>포인트</TableCell>
              <TableCell className='whitespace-nowrap' sx={{textAlign:'center'}}>이후포인트</TableCell>
              <TableCell className='whitespace-nowrap' sx={{textAlign:'center'}}>종류</TableCell>
              <TableCell className='whitespace-nowrap' sx={{textAlign:'center'}}>설명</TableCell>
