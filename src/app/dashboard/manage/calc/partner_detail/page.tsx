...
import { DynamicHeaderTable } from '@/components/dashboard/partner_simple/dynamic_table';
import { PannerSimpleHeader } from '@/app/dashboard/manage/calc/partner_simple/table_heander';
  ...
  return (
    <Grid container spacing={3} lg={12}>
      <Card>
        ...
        <div style={{height:'60dvh'}} className='overflow-y-auto relative'>
          <PartnerDetailTable         
