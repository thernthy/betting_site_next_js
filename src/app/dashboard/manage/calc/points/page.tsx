...
import { Categorys } from '@/db/category';
    ...
    <Grid container spacing={3} lg={12}>
      <Card>
        ...
        <div className='p-2 flex flex-row items-center justify-center flex-wrap lg:flex-nowrap lg:justify-start gap-3 mt-2 lg:ml-2'>
            ...
            <SearchComponent />
            <div className={`bg-sky-400 rounded-full p-3 text-white ${numser_money < 0 ? 'text-red-400' : 'text-white'}`}>
                합계: {numser_money.toLocaleString('en-US', { minimumFractionDigits: 1 })}
            </div>
        </div>
        <PintsTable         
